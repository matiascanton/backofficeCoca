  ...
  return (
    <div className="ml-10">
      ...
      <Dialog open={isModalOpen} onClose={handleCloseModal} maxWidth='lg'>
        <DialogTitle sx={{ m: 2, p: 2 }}>Puntos cliente Nro  <Chip label={client} color="primary" />  </DialogTitle>
        ...
        <DialogActions sx={{ m: 0, p: 2 }} dividers>
          <Button className="whitespace-nowrap mx-4"
            variant="contained"
            color="secondary" onClick={handleExportClient}>Descargar Excel Cliente</Button>
          <Button className="whitespace-nowrap mx-4"
            variant="outlined"
