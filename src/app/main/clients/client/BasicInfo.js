      ...
      {tabValue === 0 &&
        <>
          <Grid
            ...
            justifyItems="center"
          >
            <Grid item xs={6} md={12} style={{ height: '200px', display: 'flex', justifyContent: 'center', alignContent: 'center' }} >
              <Controller
                name="qr_code"
                control={control}
                render={({ field }) => (
                  <QRCode style={{ width: '200px', height: '200px' }} value={field} />
                )}
              />
            </Grid>
          </Grid>
              ...
              <Controller
                ...
                render={({ field }) => (
                  <TextField
                    ...
                    required
                    value={moment(field).format('DD-MM-YYYY')}
